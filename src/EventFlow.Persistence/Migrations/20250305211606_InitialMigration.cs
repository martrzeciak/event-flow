    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventEventOrganizer", x => new { x.ConcertsId, x.OrganizersId });
                    table.ForeignKey(
                        name: "FK_EventEventOrganizer_EventOrganizers_OrganizersId",
                        column: x => x.OrganizersId,
                        principalTable: "EventOrganizers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventEventOrganizer_Events_ConcertsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventEventOrganizer_OrganizersId",
                table: "EventEventOrganizer",
                column: "OrganizersId");
